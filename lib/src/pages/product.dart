...
import '../elements/AddToWaitingRoomAlertDialog.dart';
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color: Helper.canDelivery(_con.product.healer) && _con.product.deliverable ? Colors.green : Colors.orange,
                                          borderRadius: BorderRadius.circular(24)),
                                      child: Helper.canDelivery(_con.product.healer) && _con.product.deliverable
                                          ? Text(
                                              S.of(context).on_chat_only,
                                              style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                            )
                                          : Text(
                                              S.of(context).on_chat_and_video,
                                              style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                            ),
                                    ),
                                    ...
                                    SizedBox(
                                      ...
                                      child: FlatButton(
                                            ...
                                            if (_con.isSameMarkets(_con.product)) {
                                              ...
                                              showDialog(
                                                ...
                                                builder: (BuildContext context) {
                                                  ...
                                                  return AddToWaitingRoomAlertDialogWidget(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            S.of(context).add_to_waiting_room,
