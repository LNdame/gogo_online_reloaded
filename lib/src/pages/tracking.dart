              ...
              : Column(
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: Helper.getStarsList(double.parse(_con.order.productConsultations[0].product.healer.rate), size: 35),
                      ),
                    ),
                  ],
                ),
                        ...
                        child: Stack(
                          ...
                          children: <Widget>[
                                ...
                                children: <Widget>[
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        children: <Widget>[
                                          Column(
                                            ...
                                            _con.order.productConsultations.length,
                                            (indexProduct) {
                                              return ProductOrderItemWidget(
                                                  heroTag: 'my_order', order: _con.order, productOrder: _con.order.productConsultations.elementAt(indexProduct));
                                            },
                                          )),
                                          Padding(
                                  ...
                                  Container(
                                    child: Wrap(
                                      ...
                                      children: <Widget>[
                                        if (_con.order.canCancelConsultation())
                                          FlatButton(
                                            onPressed: () {
                                              showDialog(
                                                context: context,
                            ...
                            Container(
                              ...
                              child: Text(
                                _con.order.active ? '${_con.order.consultationStatus.status}' : S.of(context).canceled,
                                maxLines: 1,
                          ...
                          Padding(
                            ...
                            child: Theme(
                              ...
                              child: Stepper(
                                ...
                                currentStep: int.tryParse(this._con.order.consultationStatus.id) - 1,
                              ),
                            ),
                          ),
                          _con.order.billingAddress?.address != null
                              ? Container(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Flexible(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Text(
                                              _con.order.billingAddress?.description ?? "",
                                              overflow: TextOverflow.fade,
                                              softWrap: false,
                                              style: Theme.of(context).textTheme.subtitle1,
                                            ),
                                            Text(
                                              _con.order.billingAddress?.address ?? S.of(context).unknown,
