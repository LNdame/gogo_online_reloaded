...
class MediaBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isMe = currentUser.value.id == message.fromId;
    return Row(
                ...
                child: Align(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: isMe ? null : (message.type == MessageType.Media && message.content != null) ?  Border.all(color: Colors.white.withOpacity(0.2)) : null,
