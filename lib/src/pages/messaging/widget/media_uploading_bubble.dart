...
import 'package:gogo_online/src/repository/services/storage.dart';
...
class _MediaUploadingBubbleState extends State<MediaUploadingBubble> {
  ...
  void initState() {
    ...
    path = '$AppConstants.CHATS_MEDIA_STORAGE_REF/${widget.groupId}/$timestamp';
    _uploadTask = _storage.getUploadTask(widget.file, path);
  }

  void onUploadCompleted() async {
    var url = await _storage.getUrl(
        '$AppConstants.CHATS_MEDIA_STORAGE_REF/${widget.groupId}', '$timestamp');
