...
class MenuWidget extends StatefulWidget {
  const MenuWidget({Key key, this.routeArgument}) : super(key: key);
...
class _MenuWidgetState extends StateMVC<MenuWidget> {
  ...
  _MenuWidgetState() : super(HealerController()) {
    _con = controller;
  }

  @override
  void initState() {
    _con.healer = (new Healer())..id = widget.routeArgument.id;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text(
                S.of(context).clickOnTheConsultationToGetMoreDetailsAboutIt,
                maxLines: 2,
                style: Theme.of(context).textTheme.caption,
              ),
            ),
