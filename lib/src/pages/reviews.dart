                ...
                : SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Hero(
                                      tag: widget.routeArgument.heroTag + _con.order.productConsultations[0].product.healer.id,
                                      child: CachedNetworkImage(
                                        fit: BoxFit.cover,
                                        imageUrl: _con.order.productConsultations[0].product.healer.image.url,
                                ...
                                SizedBox(
                                  ...
                                  child: Chip(
                                    ...
                                    label: Row(
                                      ...
                                      children: <Widget>[
                                        Text(_con.order.productConsultations[0].product.healer.rate,
                        ...
                        SizedBox(height: 10),
                        Text(
                          _con.order.productConsultations[0].product.healer.name,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(S.of(context).how_would_you_rate_this_healer, textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1),
                              SizedBox(height: 10),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: S.of(context).tell_us_about_this_healer,
