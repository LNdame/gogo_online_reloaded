...
class MapController extends ControllerMVC {
  Healer currentMarket;
  List<Healer> topMarkets = <Healer>[];
  ...
  void listenForNearMarkets(Address myLocation, Address areaLocation) async {
    final Stream<Healer> stream = await getNearHealers(myLocation, areaLocation);
  ...
  void getCurrentLocation() async {
    try {
      currentAddress = sett.billingAddress.value;
      setState(() {
  ...
  Future<void> goCurrentLocation() async {
    ...
    sett.setCurrentLocation().then((_currentAddress) {
      setState(() {
        sett.billingAddress.value = _currentAddress;
