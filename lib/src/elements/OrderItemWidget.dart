    ...
    return Stack(
      children: <Widget>[
                  ...
                  child: ExpansionTile(
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        widget.order.productConsultations.length,
                        (indexProduct) {
                          return ProductOrderItemWidget(
                              heroTag: 'mywidget.orders', order: widget.order, productOrder: widget.order.productConsultations.elementAt(indexProduct));
                        },
                      )),
                      Padding(
              ...
              Container(
                child: Wrap(
                  ...
                  children: <Widget>[
                    ...
                    if (widget.order.canCancelConsultation())
                      FlatButton(
                        onPressed: () {
                          showDialog(
                            context: context,
        ...
        Container(
          ...
          child: Text(
            widget.order.active ? '${widget.order.consultationStatus.status}' : S.of(context).canceled,
            maxLines: 1,
