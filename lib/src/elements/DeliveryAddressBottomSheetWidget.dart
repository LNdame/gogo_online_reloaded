...
import '../controllers/billing_addresses_controller.dart';
...
class _DeliveryAddressBottomSheetWidgetState extends StateMVC<DeliveryAddressBottomSheetWidget> {
  BillingAddressesController _con;

  _DeliveryAddressBottomSheetWidgetState() : super(BillingAddressesController()) {
    _con = controller;
  }
          ...
          Padding(
            ...
            child: ListView(
              ...
              children: <Widget>[
                          ...
                          children: <Widget>[
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    S.of(context).add_new_billing_address,
                ...
                InkWell(
                  onTap: () {
                    _con.changeBillingAddressToCurrentLocation().then((value) {
                      Navigator.of(widget.scaffoldKey.currentContext).pop();
                    });
                  },
                  child: Row(
...
//                );
                    return InkWell(
                      onTap: () {
                        _con.changeBillingAddress(_con.addresses.elementAt(index)).then((value) {
                          Navigator.of(widget.scaffoldKey.currentContext).pop();
                        });
                      },
                      child: Row(
