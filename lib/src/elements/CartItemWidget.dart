...
class CartItemWidget extends StatefulWidget {
  String heroTag;
  Cart cart;
  VoidCallback navigateToScheduler;
  VoidCallback decrement;
  VoidCallback onDismissed;

  CartItemWidget({Key key, this.cart, this.heroTag, this.navigateToScheduler, this.decrement, this.onDismissed}) : super(key: key);
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Column( //TODO remove incrementer and add calendar
                      ...
                      children: <Widget>[
                        Ink(
                          decoration: ShapeDecoration(color: Theme.of(context).focusColor, shape: CircleBorder()),
                          child: IconButton(
                            onPressed: () {
                              setState(() {
                                widget.navigateToScheduler();
                              });
                            },
                            iconSize: 30,
