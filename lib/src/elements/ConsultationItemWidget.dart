...
class ConsultationItemWidget extends StatefulWidget {
  final bool expanded;
  final Consultation consultation;
  final ValueChanged<void> onCanceled;

  ConsultationItemWidget({Key key, this.expanded, this.consultation, this.onCanceled}) : super(key: key);

  @override
  _ConsultationItemWidgetState createState() => _ConsultationItemWidgetState();
}

class _ConsultationItemWidgetState extends State<ConsultationItemWidget> {
  @override
                  ...
                  child: ExpansionTile(
                    ...
                    trailing: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          '${widget.consultation.payment.method}',
                          style: Theme.of(context).textTheme.caption,
                        )
                      ],
                    ),
